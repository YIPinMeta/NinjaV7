...
public class BaseClass {
	...
	public void openApp(String os, String br) {
		...
		try (FileReader file = new FileReader(".//src//test//resources//config.properties")) {
			...
			switch (br.toLowerCase()) { //incase I accidentally type browser names within the test suite in upper or lowercase 
				case "chrome":
	...
	public String captureScreen(String tname) {
		...
		String targetFilePath = System.getProperty("user.dir") + "\\screenshots\\" + tname + "_" + timeStamp + ".png"; //This code takes a screenshot of failed test and uploads it to screenshot folder
